...
const char *lexicon_chinese[] = {
  "yi", "shi", "bu", "le", "ren", "wo", "zai", "you", "ta", "zhe", "zhong", "da", "lai", "shang", "ge", "dao", "shuo", "men", "wei", "zi", "he", "ni", "di", "chu", "dao", "ye", "shii", "nian", "de", "jiu", "na", "yao", "xia", "yii", "sheng", "hui", "zii", "zhee", "qu", "zhi", "guo", "jia", "xue", "dui", "ke", "taa", "li", "hou", "xiao", "me", "xin", "duo", "tian", "er", "neng", "hao", "dou", "ran", "mei", "ri", "yu", "qi", "hai", "fa", "cheng", "shie", "yong", "zhu", "xing", "fang", "youu", "ru", "qian", "suo", "ben", "jian", "jing", "tou", "mian", "gong", "tong", "san", "yie", "lao", "cong", "dong", "liang", "chang", "chengshi", "gengyan", "mingmie", "jiedeng", "zhaoyaozhe", "xingzhe", "beiying", "yumao", "kingkong", "panxuan", "hengxin", "liyue", "tiankong", "shenme", "fasheng", "qixi", "chandou", "ziyou", "feixing", "shouze", "weiyi", "tiaokuan", "xuanzhuan", "huozhe", "chaoxiang", "chicheng", "shengcun", "chengren", "youren", "wuxu", "zhengfu", "zhongli", "zhengwu", "shenhou", "dishang", "guxiang", "ditou", "lhu", "ru", "luo", "daowei", "anjiu", "zhen", "lianyi", "lian", "zhiyong", "biansushuo", "yongxinqu", "chenshan", "shouzhi", "weidao", "xintiao", "mingliao", "qinao", "jueyun", "mianao", "shijie", "dengzhe", "yichu", "nanyijie", "fangqingle", "yutian", "xihuan", "qingxin", "kanshu", "xinkan", "youxi", "jiushuan", "fannao", "shuxue", "zhidao", "sui", "xijie", "meizai", "ba", "kai", "renmian", "nong", "biaoqing", "shenqi", "zhongyu", "xiangling", "shengbu", "tifang", "tongdui", "pian", "leiguang", "cangxie", "shoucang", "yuanyi", "diaoxie", "diao", "xie", "mengzheng", "guoleng", "shilian", "youshi", "woyao", "wocheng", "fengben", "feng", "benpao", "pao", "liwu", "zu", "fazu", "fuhao", "haowu", "zaixuan", "laibu", "ganyu", "nimen", "tamen", "zheli", "nali", "woumen", "jiuzhe", "yangzi", "liqu", "xindeng", "cai", "buwanggu",
  "\n"
};
