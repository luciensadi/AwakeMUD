...
const char *adept_powers[] =
  {
    ...
    "Improved Body",
    "Improved Perception",
    "Low Light Improved Sense",
    "Thermographic Improved Sense",
    "Magnification Improved Sense",
    "Magic Resistance",
    "Pain Resistance",
...
struct skill_data skills[] =
  {
    ...
    {"Computer Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Biotech", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Electronics Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    ...
    {"Edged Weapons Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Polearms Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Clubs Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Throwing Weapons Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Whips/Flails Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Projectiles Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Pistols Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Shotguns Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Rifles Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Heavy Weapons Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Submachine Guns Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
    {"Armor Build and Repair", INT, SKILL_TYPE_ACTIVE, FALSE},
