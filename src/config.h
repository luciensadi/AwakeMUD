...
#define HOST_SECURITY_GREEN_MARKET_MAXIMUM                     1000
#define HOST_SECURITY_ORANGE_MARKET_MAXIMUM                    2000
#define HOST_SECURITY_RED_MARKET_MAXIMUM                       3000
#define HOST_SECURITY_BLACK_MARKET_MAXIMUM                     5000

#define HOST_SECURITY_BLUE_MARKET_MINIMUM                      100
#define HOST_SECURITY_GREEN_MARKET_MINIMUM                     200
#define HOST_SECURITY_ORANGE_MARKET_MINIMUM                    300
#define HOST_SECURITY_RED_MARKET_MINIMUM                       400
