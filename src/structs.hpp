...
struct room_direction_data
{
  ...
  time_t last_player_interaction;
  ...
  room_direction_data() :
      ...
      to_room_vnum(NOWHERE), last_player_interaction(0), go_into_secondperson(NULL),
      go_into_thirdperson(NULL), come_out_of_thirdperson(NULL)
  {
    #ifdef USE_DEBUG_CANARIES
      canary = CANARY_VALUE;
    #endif
...
struct player_special_data_saved
{
  ...
  player_special_data_saved() :
    ...
    system_points(0), restricted_system_points(0), mudvault_verified(FALSE), last_vote_time(0),
    best_normal_lifestyle(LIFESTYLE_SQUATTER),
