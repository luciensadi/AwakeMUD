...
#define COULD_BE_ON_QUEST(ch) (ch && AFF_FLAGGED(ch, AFF_GROUP) && (IS_NPC(ch) || GET_QUEST(ch)))
...
struct quest_data
{
  ...
  quest_data() :
      ...
      disqualifying_quest(0), nuyen(0), karma(0), reward(-1), obj(NULL), mob(NULL), intro(NULL),
