          ...
          (i = rand(1,9) {
            switch(i) {
              ...
              case 2:
                ...
                break;
              case 3:
                send_to_char("The poor-quality metal shavings you're trying to turn into a bullet disintegrate. you curse the entire lineage of the fixer who gave you these materials\r\n", CH);
                break;
              case 4:
                send_to_char("Somehow, Chinese comes unbidden to your lips. You think you said something unspeakable about a dog - regardless, the bullet is now tainted. You discard it.\r\n", CH);
                break;
              case 5:
